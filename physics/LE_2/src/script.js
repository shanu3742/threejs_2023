...
/**
 * call a function   to create a new sphere  
 * using dat,gui
 */
...
gui.add(onAddSphere,'createSphere')
...
const tick = ()=> {
    ...
    // spherBody.applyForce(new CANNON.Vec3(-0.1,0,0),spherBody.position)
     ...
     sphereList.forEach((sphere,sphereIndex) => {
